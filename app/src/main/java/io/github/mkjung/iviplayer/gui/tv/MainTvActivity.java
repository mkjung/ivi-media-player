...
//        });
    ...
    public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row) {
        if (row.getId() == HEADER_CATEGORIES) {
            ...
            if (id == ID_SETTINGS)
                startActivityForResult(new Intent(this, io.github.mkjung.iviplayer.gui.tv.preferences.PreferencesActivity.class), ACTIVITY_RESULT_PREFERENCES);
            else if (id == ID_ABOUT)
                startActivity(new Intent(this, io.github.mkjung.iviplayer.gui.tv.AboutActivity.class));
            else if (id == ID_LICENCE)
                startActivity(new Intent(this, io.github.mkjung.iviplayer.gui.tv.LicenceActivity.class));
        } else {
